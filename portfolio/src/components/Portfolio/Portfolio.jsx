...
function HoneyAbout() {
    return (
        <div className={`${Styles.about} ${Styles.aboutText}`}>
    ...
    return (
        <div className={`${Styles.portfolio}`}>
            ...
            <div className={`${Styles.cards} container`}>
                ...
                <SiteCard Screen={"/Imgs/Screens/portfolio-screen.png"} Demo={"https://dobbylou.github.io/Velocity/"} Git={"https://github.com/DOBBYLOU/Velocity.git"} Name={<PortfolioText />} About={<PortfolioAbout />} />
            </div>
        </div>
    )
}
